 ...
 * @author korisnik
 */
public class PromeniLozinkuNeuspesnoNeslaganje {
    
    public static String baseUrl = "http://localhost/projekat4/ankete2/login.php";
    public static WebDriver driver;
    
    public PromeniLozinkuNeuspesnoNeslaganje() {
    }

    @Parameters({"username", "stara", "nova", "potvrdi"})
    @Test
    public void PromeniLozinkuNeuspesnoNeslaganjeChrome(@Optional("milica") String username,@Optional("milica") String stara,@Optional("milic") String nova,@Optional("milica") String potvrdi){
    ...
    @Parameters({"username", "stara", "nova", "potvrdi"})
    @Test
    public void PromeniLozinkuNeuspesnoNeslaganjeFirefox(@Optional("milica") String username,@Optional("milica") String stara,@Optional("milic") String nova,@Optional("milica") String potvrdi){
